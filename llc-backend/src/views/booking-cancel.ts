...
// booking cancellation sent to client
export const clientBookingCancellationEmailTemplate = (
    ...
    <body style="margin: 0; padding: 0; background-color: #f3f4f6; font-family: Arial, sans-serif;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e7eb;">
        ...
        <div
          ...
          <div style="font-size: 14px;">Booking cancellation service</div>
        </div>
        ...
        <div style="padding: 30px;">
          <h1 style="font-size: 24px; font-weight: normal; color: #111827; margin-bottom: 30px;">Hello ${
            ...
            booking has been <span style="color: #CBA135; font-weight: bold;">cancelled!</span></h1>
        </div>
        ...
        <!-- Trip Details -->
        <div style="padding: 30px;">
          <h2 style="font-size: 16px; font-weight: bold; color: #111827; margin-bottom: 16px;">Cancelled Trip Details</h2>
        ...
        <div style="padding: 30px; background-color: #f9fafb; border-bottom: 1px solid #e5e7eb;">
          ...
          <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
            <p style="margin: 0; font-size: 16px; color: #4B5563;">Base Fare (Initially paid)</p>
          ...
          <div
            ...
            <p style="margin: 0; font-size: 16px; color: #111827;">Total Refund Amount</p>
            <p style="margin: 0; font-size: 16px; color: #111827;">$${estimatedFare}</p>
          </div>
        </div>
